            ...
            child: Row(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 8),
                  child: Text(
                    '${widget.order.address.address} ,${widget.order.address.city.name}, ${widget.order.address.street}',
                    style: TextStyle(
                      fontSize: 10,
                      color: const Color(0xff3c4959),
                    ),
                ...
                Text(
                  '${widget.order.address.unitNumber}, ${widget.order.address.buildingNumber}',
                  style: TextStyle(
                    fontSize: 8,
